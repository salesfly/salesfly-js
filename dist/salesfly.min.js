var SalesflyClient = (function (e) {
  ...
  function (e) {
    e.exports = {
      name: 'salesfly-js',
      version: '0.9.2',
      description: 'Javascript client for Salesfly API',
      main: 'lib/index.js',
      homepage: 'https://github.com/salesfly/salesfly-js',
      keywords: [],
      author: 'Salesfly',
      license: 'MIT',
      scripts: {
      ...
      repository: {
        type: 'git',
        url: 'git+https://github.com/salesfly/salesfly-js.git',
      },
      bugs: { url: 'https://github.com/salesfly/salesfly-js/issues' },
  ...
  function (e, t, n) {
    ...
    class i {
      ...
      get(e, t) {
        const n = t || { fields: '', hostname: !1, security: !1 }
        let r = this.client.makeQuery(n)
        return this.client.get('/geoip/' + e + r)
      }
      getCurrent(e) {
        return this.get('myip', e)
      }
      getBulk(e, t) {
        const n = t || { fields: '', hostname: !1, security: !1 }
        let r = this.client.makeQuery(n)
    ...
    e.exports = class {
      constructor(e) {
        const t = new r(e)
        ;(this.geoip = new i(t)), (this.usage = new s(t))
      }
      getVersion() {
        return o
      }
  ...
  function (e, t, n) {
    const r = n(10),
      o = n(30),
      i = 'salesfly-js/' + n(7).version,
      s = 'https://api.salesfly.com/rest/v1',
      u = 30
    e.exports = class {
      constructor(e) {
        const t = e || {}
        ;(this.apiKey = t.apiKey),
          (this.apiBaseURL = t.apiBaseURL || s),
          (this.timeout = t.timeout || u),
          (this.logger = t.logger)
      }
      get(e) {
        return this._request('GET', e, null)
      }
      patch(e, t) {
        return this._request('PATCH', e, t)
      }
      post(e, t) {
        return this._request('POST', e, t)
      }
      put(e, t) {
        return this._request('PUT', e, t)
      }
      delete(e) {
        return this._request('DELETE', e, null)
      }
      makeQuery(e) {
        let t = []
        for (let n in e)
      ...
      _request(e, t, n) {
        if (this.logger) {
          ...
          this.logger.debug(`${n} [DEBUG] ${e} ${t}`)
        }
        let s = { Accept: 'application/json' }
        return (
          n && (s['Content-Type'] = 'application/json charset=utf-8'),
          this.apiKey && (s.Authorization = 'Bearer ' + this.apiKey),
          o() && (s['User-Agent'] = i),
          r({
            method: e,
            url: t,
            ...
            .catch((e) => {
              if (e.response) {
                if (this.logger) {
                  ...
                  this.logger.error(
                    `${t} [ERROR] ${e.response.data.message} (${e.response.data.code})`
                  )
                }
              ...
              }
              {
                ...
                if (
                  ...
                  let n = new Date().toISOString()
                  this.logger.error(`${n} [ERROR] ${t} (${e.code})`)
                }
                throw { status: 0, success: !1, code: e.code, message: t }
              }
            })
        )
      }
